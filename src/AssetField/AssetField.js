...
class AssetField extends Component {
  ...
  render(){
    ...
    switch (fieldInfo.name){
      ...
      break;
      case 'score':
        output = this.props.tokenConfig.defiScoreDisabled ? <Text {...fieldProps}>N/A</Text> : this.state.score !== undefined && this.state.score !== null && this.functionsUtil.BNify(this.state.score).gt(0) ? (
