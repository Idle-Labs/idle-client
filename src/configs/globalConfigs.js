...
const globalConfigs = {
  ...
  messages:{
    ...
    batchDepositExecutionSchedule:'Batches are executed twice a week, usually on Sunday and Wednesday, if the pool size is at least 20k big. The time of each execution will vary depending on the gas price of the Ethereum network.',
